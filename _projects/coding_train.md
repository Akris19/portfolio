...
<figure class="media media--medium">
  <img src="{{ '/assets/resources/reading-train-cover.png' | relative_url }}" alt="The Reading Train prototype on wooden tracks">
  <figcaption>The Reading Train prototype on wooden tracks</figcaption>
</figure>
...
<figure class="media media--medium">
  <img src="{{ '/assets/resources/reading-train-track-testing.png' | relative_url }}" alt="Children experimenting with different track layouts">
  <figcaption>Children experimenting with different track layouts</figcaption>
</figure>
...
<figure class="media media--medium">
  <img src="{{ '/assets/resources/reading-train-robot-arm-lego.png' | relative_url }}" alt="LEGO robot arm prototype used during early exploration">
  <figcaption>LEGO robot arm prototype used during early exploration</figcaption>
</figure>
...
<figure class="media media--medium">
  <img src="{{ '/assets/resources/reading-train-marker-test.png' | relative_url }}" alt="Testing black markers on wooden tracks">
  <figcaption>Testing black markers on wooden tracks</figcaption>
</figure>
...
<div class="media-grid media-grid--3">
  <figure class="media-grid__item">
    <img src="{{ '/assets/resources/reading-train-modular-body.png' | relative_url }}" alt="Modular train body with peg system">
    <figcaption>Modular train body with peg system</figcaption>
  </figure>
  <figure class="media-grid__item">
    <img src="{{ '/assets/resources/reading-train-differential-gear.png' | relative_url }}" alt="Differential Gear printed with a 2mm nozzle">
    <figcaption>Differential Gear printed with a 2mm nozzle</figcaption>
  </figure>
  <figure class="media-grid__item">
    <img src="{{ '/assets/resources/reading-train-ackermann-steering.png' | relative_url }}" alt="Ackermann steering">
...
<figure class="media media--medium">
  <img src="{{ '/assets/resources/reading-train-assembly-guide.png' | relative_url }}" alt="Assembly guide for the train prototype">
  <figcaption>Assembly guide for the train prototype</figcaption>
</figure>
